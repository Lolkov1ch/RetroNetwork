    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.CharField(blank=True, help_text='Public nickname (can contain spaces)', max_length=50)),
                ('handle', models.CharField(help_text='Unique username (2-30 chars, no spaces)', max_length=30, unique=True, validators=[users.models.validate_handle])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_visibility', models.CharField(choices=[('all', 'All'), ('friends', 'Friends'), ('none', 'Nobody')], default='all', max_length=10)),
